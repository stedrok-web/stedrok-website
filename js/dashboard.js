...
function normalizePickRowShape(stock) {
  ...
  return {
    ...
    discount_pct: (() => { const _d = toNumberOrNull(row.discount_pct ?? row.discountPct); if (_d == null) return _d; const _isSwarm = (row.swarm_score != null || row.swarmScore != null); if (_isSwarm) return _d; return Math.abs(_d) <= 3.5 ? _d * 100 : _d; })(),
