...
function renderTable(stocks) {
  ...
  stocks.forEach(stock => {
    ...
    const const const geminiBadgeHtml = stock.gemini_selected ? '<span class="badge badge-ai-pick ticker-ai-badge" title="Selected by Gemini AI as a top high-conviction pick">★ TOP</span>' : '';
